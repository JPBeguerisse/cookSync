...
export const HomePage = () => {
  ...
  useEffect(() => {
    axios
      ...
      .catch((err) => {
        setErrorFeatured(err.response?.data?.message || err.message);
        setLoadingFeatured(false);
      });
  }, []);
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_API_URL}/api/lowCaloriesRecipes`)
      .then((response) => {
      ...
      .catch((err) => {
        setErrorLow(err.response?.data?.message || err.message);
        setLoadingLow(false);
      });
  }, []);
  ...
  useEffect(() => {
    axios
      ...
      .catch((err) => {
        setErrorHigh(err.response?.data?.message || err.message);
        setLoadingHigh(false);
      });
  }, []);
  ...
  function RenderCarousel({
    ...
    return (
      <section
        ...
        className="py-8 xl:mx-auto xl:max-w-7xl xl:px-8"
      >
        ...
        <div className="px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 xl:px-0">
          ...
          <Link
            to={linkAll}
            className="hidden text-sm font-semibold text-[#7C3AED] hover:text-purple-800 sm:block"
          >
            {linkTitle}
                ...
                <div className="absolute flex space-x-6 px-4 sm:px-6 lg:px-8 xl:relative xl:grid xl:grid-cols-5 xl:gap-x-8 xl:space-x-0 xl:px-0">
                  {Array(5)
                    ...
                    .map((_, index) => (
                      <div
                        key={index}
                        className="relative flex h-72 w-48 flex-col overflow-hidden rounded-lg bg-gray-100 p-4 animate-pulse xl:w-auto"
                      >
                ...
                <div className="absolute flex space-x-6 px-4 sm:px-6 lg:px-8 xl:relative xl:grid xl:grid-cols-5 xl:gap-x-8 xl:space-x-0 xl:px-0">
                  {items.map((recipe) => (
                    <Link
                      ...
                      className="relative flex h-72 w-48 flex-col overflow-hidden rounded-lg bg-gray-100 p-4 hover:opacity-75 xl:w-auto"
                    >
        ...
        <div className="mt-4 px-4 sm:hidden">
          <Link
            to={linkAll}
            className="block text-sm font-semibold text-[#7C3AED] hover:text-purple-800"
          >
  ...
  return (
    <div className="bg-white">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(https://i.goopics.net/yuq6o2.jpg)",
        }}
      >
        <div className="relative mx-auto flex max-w-3xl flex-col items-center px-6 py-32 text-center sm:py-64 lg:px-0">
          ...
          <p className="mt-4 text-xl text-white">
            Découvrez les recettes les plus savoureuses et faciles à réaliser.
            Cliquez sur “Voir toutes les recettes” pour parcourir notre
            collection complète.
          </p>
          <Link
            to="/recipes"
      ...
      <main>
        <RenderCarousel
          ...
          linkAll="/recipes"
          linkTitle="Voir toutes les recettes"
        />
        <section
        ...
        >
          <div className="relative overflow-hidden rounded-lg">
            <div className="absolute inset-0">
              <img
                alt="Cuisine gourmande"
                src="https://i.goopics.net/jcme3g.jpg"
            ...
            <div className="relative bg-gray-900/75 px-6 py-32 sm:px-12 sm:py-40 lg:px-16">
              <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
                ...
                <p className="mt-3 text-xl text-white">
                  Obtenez instantanément des recettes personnalisées grâce à
                  notre intelligence artificielle. Décrivez vos ingrédients ou
                  vos envies, et laissez notre outil vous guider vers des plats
                  savoureux.
                </p>
                <Link
                  to="/recipes/generate"
        ...
        <RenderCarousel
          ...
          loading={loadingLow}
          error={errorLow}
          title="Recettes faibles en calories"
          linkAll="/recipes/low-calories"
          linkTitle="Voir toutes les recettes faibles en calories"
        />
        <RenderCarousel
          items={highCal}
          loading={loadingHigh}
          error={errorHigh}
          title="Recettes riches en calories"
          linkAll="/recipes/high-calories"
          linkTitle="Voir toutes les recettes riches en calories"
        />
        <section
          aria-labelledby="inspiration-heading"
          className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8"
        >
          <div className="relative overflow-hidden rounded-lg">
            <div className="absolute inset-0">
              <img
                alt="Cuisine gourmande"
                src="https://i.goopics.net/7im23x.jpg"
                className="size-full object-cover"
              />
            </div>
            <div className="relative bg-gray-900/75 px-6 py-32 sm:px-12 sm:py-40 lg:px-16">
              <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
                ...
                <p className="mt-3 text-xl text-white">
                  Découvrez des recettes équilibrées, qu’elles soient faibles en
                  calories pour garder la ligne ou riches pour les gourmands.
                  Notre sélection s’adapte à chaque envie, sans compromis sur le
                  goût.
                </p>
                <Link
                  to="/contact"
