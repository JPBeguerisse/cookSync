...
export const LowCaloriesPage = () => {
  ...
  filterTypes.forEach((t) => {
    activeFilterBadges.push({ id: `type__${t}`, label: t });
  });
    ...
    <div className="bg-white">
      ...
      >
        <ol className="flex space-x-2">
          ...
          <span className="mx-2">/</span>
          <li className="text-gray-500">Faible en calories</li>
        </ol>
      </nav>
      <Dialog
        as="div"
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <p className="mb-6 text-base text-gray-500">
          Découvrez nos recettes avec ≤ 700 kcal. Appliquez recherche, filtres
          et tri comme d’habitude.
        </p>
