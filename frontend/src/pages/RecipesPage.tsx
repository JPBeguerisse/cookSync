...
export const RecipesPage = () => {
  ...
  const allTypes = Array.from(
    new Set(
      recipes
        .map((recipe) => (recipe.Type ? recipe.Type.toString().trim() : ""))
    ...
    <div className="bg-white">
      ...
      >
        <ol className="flex space-x-2">
          ...
          <li className="text-gray-500">Recettes</li>
        </ol>
      </nav>
      <Dialog
        as="div"
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <p className="mb-6 text-base text-gray-500">
          Parcourez une sélection de plats savoureux et faciles à réaliser pour
          régaler vos proches au quotidien.
        </p>
